                          ...
                          child: Column(
                            ...
                            children: [
                              Padding(
                                ...
                                child: Text(books.title,textAlign: TextAlign.center,style: TextStyle(fontWeight: FontWeight.bold,color: Colors.lightBlueAccent,fontSize: 20,shadows: <Shadow>[
                                  Shadow(
                              ...
                              Padding(
                                ...
                                child: Text(books.authors[0],style: TextStyle(color: Colors.white,fontSize: 15,shadows: <Shadow>[
                                  Shadow(
